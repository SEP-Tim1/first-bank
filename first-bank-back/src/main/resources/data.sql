insert into cards(id, card_holder_name, pan, security_code, expiration_date, account_id) values (0, 'Pera Detlic', '3gjwVFdANZCWKhRqeB5LDE8jLsWUmWJuVoZy+umar9s=', 'WJDbTKvG4mZo1BiasoxGhA==', '2028-03-11', 0);
insert into cards(id, card_holder_name, pan, security_code, expiration_date, account_id) values (1, 'Pera Detlic', '6S+6qDCKitSgp48EsM2kEE8jLsWUmWJuVoZy+umar9s=', 'WJDbTKvG4mZo1BiasoxGhA==', '2028-11-11', 0);
...
insert into accounts(id, balance, currency, m_id, m_password) values (1, 500000, 1, 603760, '3jgcvKq9WaZyinn3oeqWPw/y8GwByeS+UZtddLu/qzI=');
